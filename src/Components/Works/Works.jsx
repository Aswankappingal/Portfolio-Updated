...
const Works = () => {
    ...
    const projectsData = [
        {
            id: 1,
            title: "Karikku Web App",
            category: ["web", "fullstack"],
            image: "/Images/Karikkuweb.png",
            ...
            liveLink: "https://karikku.co/",
        },
        {
            id: 2,
            title: "Tharacart Marketplace",
            category: ["web", "fullstack"],
            image: "/Images/Tharacart Web app.png",
            technologies: ["React", "SCSS", "Node.js", "Firestore", "Payment Gateway"],
            description: "An e-commerce website similar to Flipkart, featuring product listings, cart functionality, and secure checkout.",
            liveLink: "https://tharacart.com/",
        },
        {
            id: 3,
            title: "Limra Doors",
            category: ["web", "frontend"],
            image: "/Images/Noor-al-atif.png",
            technologies: ["HTML", "SCSS", "JavaScript", "Tailwind"],
            description: "A website  Noor Al Atif Technical Services, we pride ourselves on delivering top-quality technical services to transform, maintain, and enhance residential, commercial, and industrial spaces",
            liveLink: "https://nooralatiftech.com/",
        },
        {
            id: 4,
            title: "Firstlogic Metalab",
            category: ["web", "frontend"],
            image: "/Images/Firstlogic.png",
        ...
        },
        {
            ...
            category: ["web", "frontend"],
            image: "/Images/Firstlogic-insitute.png",
            technologies: ["React", "JavaScript", "SCSS"],
        ...
        <div className='ProjectsMainWrapper' id="projects" ref={projectsRef}>
            ...
            <div className="container">
                ...
                <div className="more-projects-section">
                    ...
                    <a href="https://github.com/Aswankappingal" target="_blank" rel="noopener noreferrer" className="github-link">
